...
export function getCuandoSurteEfectos(tipoNotificacion, parteRecurrente, esAutoridadTercero = false) {
  ...
  // Fracción I del artículo 31 - Autoridades responsables
  if (parteRecurrente === 'autoridad') {
    return 'el mismo día';
  }
...
export function getFundamentoSurtimientoEfectos(tipoNotificacion, parteRecurrente, esAutoridadTercero = false) {
  ...
  // Fracción I - Autoridades
  if (parteRecurrente === 'autoridad' || (parteRecurrente === 'tercero' && esAutoridadTercero)) {
...
export function getTextoExplicativoSurtimientoEfectos(tipoNotificacion, parteRecurrente, esAutoridadTercero = false) {
  ...
  if (parteRecurrente === 'autoridad' || (parteRecurrente === 'tercero' && esAutoridadTercero)) {
    return `De conformidad con el ${fundamento}, las notificaciones a las autoridades surten efectos el mismo día en que se practican.`;
  }
